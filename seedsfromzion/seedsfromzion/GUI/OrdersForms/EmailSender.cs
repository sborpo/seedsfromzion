...
namespace seedsfromzion.GUI.OrdersForms
{
    public static class EmailSender
    {
        ...
        {
            MySqlCommand command = DataAccessUtils.commandBuilder("SELECT  P.name, P.type ,O.units  FROM seedsdb.ordersfromstorage O ,seedsdb.planttypes P WHERE O.plantId=P.plantId AND orderId=@Order", "@Order", orderId.ToString());
